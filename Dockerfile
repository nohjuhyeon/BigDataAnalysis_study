...
ARG BRANCH_NAME=BigDataAnalysis_study
ARG DIR_NAME=BigDataAnalysis_study # 변경대상
...
RUN git clone https://github.com/nohjuhyeon/BigDataAnalysis_study ${DIR_NAME}           # 변경대상
